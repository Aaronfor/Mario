...
if( $_POST )
{
  ...
  ///llamamos a la funcion la cual agregara al nuevo jugador y le enviamos los parametros que serian sus datos y ademas el tipo de usuario que es en este caso 1 seria futbolista
  add( $id, $name,$posicion,$carrera,$email,1);
