                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $field[$sum][2]; ?></td>
                     <!--se enviara la matricula por medio del metodo get a un archivo llamado key2.php-->
                    <td><a href="key2.php?id=<?php echo $field[$sum][0];?>" class="button radius tiny secondary">Ver detalles</a></td>
                  </tr>
                  <?php
                  } 
